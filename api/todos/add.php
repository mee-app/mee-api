...
$stmt = $conn->prepare("INSERT INTO `todos`(`name`, `completed`, `desc`, `alarmActivated`, `notifActivated`, `limitDate`, `priority`, `earlyNotif`, `owner`) VALUES (?,?,?,?,?,?,?,?,?)");
$stmt->bind_param("sisiisiis", $name, $completed, $desc, $alarmActivated, $notifActivated, $limitDate, $priority, $earlyNotif, $owner);
